...
namespace telegramShpigonGameBot
{
    ...
    internal class BotMessagesUkrainian
    {
        ...
        public Dictionary<string, string> textMessages = new Dictionary<string, string>
        {
            ...
            {"help", "<b>Правила гри</b>\n\nГра складається з 5 основних раундів:\n- раунд представлень\n- раунд асоціацій\n- раунд запитань\n- раунд описів\n- раунд дій\nПілся кожного раунду буде коло припущень.\n\nЗадача шпигуна в тому, щоб не дати іншим зрозуміти, що він шпигун, і встигнути зрозуміти на якій локації він знаходиться. Задача інших гравців - викрити шпигуна для того, щоб під час голосування в кінці гри більшість голосів отримав саме шпигун.\n\n<b>Гра займає приблизно 20 хвилин часу</b>"},
            ...
            {"startgameAdvice", "Хай всі, хто буде приймати участь у грі, натиснуть на кнопку <b>Я граю!</b> Після того, як всі будуть готові почати гру, хтось має натиснути <b>Готові!</b>\n\n"},
            ...
            {"readyRoleCivilian", "<b>Ваша роль на цю гру: </b>"},
            {"readyRoleSpy", "<b>Ваша роль на цю гру:</b> Шпигун."},
            {"gamestarted", "<b>Гру розпочато</b>\nВсі мали отримати ролі і інформацію про локацію на поточну гру в <b>особистому повідомленні від бота.</b>"},
            ...
            {"round1Advice", "<b>Раунд 1: Представлення</b>\nКожен з гравців по черзі має представитися <b>вигаданим псевдонімом, який мав би відноситися до локації і вашої ролі.</b> Використовуйте неочевидні псевдоніми, щоб шпигун не здогадався, що це за локація; але не використовуйте надто складні псевдоніми, щоб інші (не шпигуни) мали змогу зрозуміти, що ви не є шпигуном.\n\n<b>Раунд триватиме 2 хвилини. Коли ви натиснете, почнеться зворотній відлік.</b>"},
            ...
            {"votingAllVotedAdvice", "\n\nЗараз шпигун має змогу розкритися, якщо воліє цього. В такому разі він має просто назвати локацію, яку він вважає правильною. Якщо шпигун називає локацію правильно, він переміг в цій грі.\n\n<b>Чи розкривається шпигун?</b>"},
